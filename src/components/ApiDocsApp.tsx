        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-xs font-bold text-[var(--positive)] flex items-center gap-1">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <span className="text-[10px] font-black font-mono px-1.5 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/30 text-[var(--positive)]">
                      {ep.method}
                    </span>
                  </div>
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="p-5 rounded-2xl border" style={{ background: 'var(--bg-surface)', borderColor: 'var(--border)' }}>
            <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
              <div className="flex items-center gap-2">
                <span className="px-2 py-0.5 text-xs font-black font-mono rounded bg-emerald-500/10 border border-emerald-500/30 text-[var(--positive)]">
              ...
              <div className="flex items-center gap-1 p-1 rounded-xl border text-xs font-bold" style={{ background: 'var(--bg-surface-2)', borderColor: 'var(--border)' }}>
                <button
                  ...
                  className={`px-3 py-1 rounded-lg transition cursor-pointer ${activeTab === 'tester' ? 'bg-[var(--accent-strong)] text-zinc-950 font-black' : 'text-zinc-400 hover:text-zinc-200'}`}
                >
                  Live Tester
                </button>
                <button
                  ...
                  className={`px-3 py-1 rounded-lg transition cursor-pointer ${activeTab === 'code' ? 'bg-[var(--accent-strong)] text-zinc-950 font-black' : 'text-zinc-400 hover:text-zinc-200'}`}
                >
                  Code Generator
                </button>
                <button
                  ...
                  className={`px-3 py-1 rounded-lg transition cursor-pointer ${activeTab === 'docs' ? 'bg-[var(--accent-strong)] text-zinc-950 font-black' : 'text-zinc-400 hover:text-zinc-200'}`}
                >
                  Parameters
                </button>
              </div>
              ...
              <div className="p-4 rounded-xl border" style={{ background: 'var(--bg-surface)', borderColor: 'var(--border)' }}>
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                  <div className="flex-1 px-3 py-2 text-xs font-mono rounded-lg border overflow-x-auto whitespace-nowrap"
                    ...
                    <span className="text-[var(--positive)] font-bold mr-2">GET</span>
                    {displayUrl}
                  </div>
                  <button
                    type="button"
          ...
          {activeTab === 'code' && (
            <div className="p-5 rounded-2xl border space-y-4" style={{ background: 'var(--bg-surface)', borderColor: 'var(--border)' }}>
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div className="flex items-center gap-1.5 p-1 rounded-xl border text-xs font-bold" style={{ background: 'var(--bg-surface-2)', borderColor: 'var(--border)' }}>
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg transition cursor-pointer ${selectedLang === 'csharp' ? 'bg-[var(--accent-strong)] text-zinc-950 font-black' : 'text-zinc-400 hover:text-zinc-200'}`}
                  >
                    C# (HttpClient)
                  </button>
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg transition cursor-pointer ${selectedLang === 'js' ? 'bg-[var(--accent-strong)] text-zinc-950 font-black' : 'text-zinc-400 hover:text-zinc-200'}`}
                  >
                    JavaScript (fetch)
                  </button>
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg transition cursor-pointer ${selectedLang === 'py' ? 'bg-[var(--accent-strong)] text-zinc-950 font-black' : 'text-zinc-400 hover:text-zinc-200'}`}
                  >
                    Python (requests)
                  </button>
                  <button
                    ...
                    className={`px-3 py-1 rounded-lg transition cursor-pointer ${selectedLang === 'curl' ? 'bg-[var(--accent-strong)] text-zinc-950 font-black' : 'text-zinc-400 hover:text-zinc-200'}`}
                  >
                    cURL
                  </button>
                </div>
              ...
              <pre className="p-4 rounded-xl border font-mono text-xs overflow-x-auto text-[var(--positive)] leading-relaxed"
                   style={{ background: '#090a0f', borderColor: 'var(--border)' }}>
                {codeSnippet}
              </pre>
            ...
            <div className="space-y-4">
              <div className="p-5 rounded-2xl border space-y-3" style={{ background: 'var(--bg-surface)', borderColor: 'var(--border)' }}>
                ...
                <ul className="text-xs list-disc pl-5 space-y-1 text-zinc-400">
                  <li><strong className="text-zinc-200">Custom Header (Recommended):</strong> <code className="text-[var(--positive)]">x-api-key: &lt;key&gt;</code>. Ideal for HTTP clients such as C# <code className="text-zinc-300">HttpClient</code>, Node <code className="text-zinc-300">fetch()</code>, and Python <code className="text-zinc-300">requests</code>.</li>
                  <li><strong className="text-zinc-200">Authorization Bearer:</strong> <code className="text-[var(--positive)]">Authorization: Bearer &lt;key&gt;</code>. Compatible with standard OAuth2 / JWT client libraries.</li>
                  <li><strong className="text-zinc-200">URL Query Parameter:</strong> <code className="text-[var(--positive)]">?api_key=&lt;key&gt;</code>. Useful for browser URL navigation, webhooks, or image loading.</li>
                </ul>
              </div>
              ...
              <div className="p-5 rounded-2xl border space-y-3" style={{ background: 'var(--bg-surface)', borderColor: 'var(--border)' }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                  <div className="p-3 rounded-lg border" style={{ background: 'var(--bg-surface-2)', borderColor: 'var(--border)' }}>
                    <div className="font-mono font-bold text-[var(--positive)]">200 OK</div>
...
{`"pagination": {
  ...
  "has_prev": false
                ...
                <p className="text-xs text-zinc-400">
                  Clients should consume <code className="text-[var(--positive)]">has_next</code> and advance <code className="text-[var(--positive)]">page</code> parameter for cursor iteration.
                </p>
              </div>
            </div>
          )}
